        ...
        <div class="page-header float-right">
          <div class="page-title">
            <ol class="breadcrumb text-right">
              <li> <a href="User/index.php">Kembali ke Halaman Utama</a></li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="mediumModalLabel">Detail Smartphone </h5>
              ...
              <table class="table table-sm">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Brand Smartphone</th>
                    <th scope="col">Harga Smartphone</th>
                  </tr>
                </thead>
                <tbody>
                  <?php
                  include 'connect.php';
      						$sql="select nama,brand,harga from handphone ";
      						$result=mysqli_query($conn, $sql);

      						$no=1;
      						while ($a=mysqli_fetch_array($result, MYSQLI_ASSOC)){
                    echo "<tr><td>$a[nama]</td><td>$a[brand]</td><td>$a[harga]</td></tr>";
                     $no++;
      						}
                  echo "</tbody></table>";
      						?>
      ...
      <div  class="col-sm-6 ">
        <div class="card text-white bg-flat-color-1">
          <div class="card-body pb-0">
            ...
            <?php
                  include 'connect.php';
                  $sql= "select nama from handphone ";
                  $result= mysqli_query($conn, $sql);
            ...
            <p class="text-light">Total Data Smartphone</p>
