            ...
            <div class="col-sm-4">
              <div class="page-header float-left">
                <div class="page-title">
                  <h1>Harga Smartphone Range 4</h1>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <strong class="card-title"><h3>Smartphone Harga Range 4</h3></strong>
              </div>
              <div class="card-body">
                <table>
                  <tr>
                  ...
                  <?php
                  include 'connect.php';
                  $database = "SELECT * FROM handphone where harga >= 6100000 and harga <= 8000000";
