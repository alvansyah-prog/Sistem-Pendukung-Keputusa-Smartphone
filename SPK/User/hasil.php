...
<body>
			...
			<div class="container pageTitle">
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<h2 class="page-title">Hasil Pemilihan Smartphone</h2>
					</div> <!-- /.col-md-6 -->
				</div> <!-- /.row -->
			</div> <!-- /.container -->
	...
	<div class="col-md-12">
		<br>
		<a class="active" href="#">Rekomendasi Smartphone</a>
		<br>
	</div>
			...
			<div class="col-md-12">
				<table class="table table-striped jambo_table bulk_action">
					<thead class="thead-dark">
						<p><b>Convert ke Bilangan Fuzzy</b></p>
						<tr>
                         	<th scope="col">Nama</th>
                         	<th scope="col">Brand</th>
                         	<th scope="col">Harga</th>
                         	<th scope="col">Bobot RAM</th>
                         	<th scope="col">Bobot Internal</th>
                         	<th scope="col">Bobot Processor</th>
                         	<th scope="col">Bobot Kamera Utama</th>
                         	<th scope="col">Bobot Layar</th>
                         	<th scope="col">Bobot Baterai</th>
                        </tr>	
					</thead>
					<tbody>
						<?php 
									...
									$cek = mysqli_query($conn, "SELECT h.nama as Nama, h.brand as Brand,h.harga as Harga,h.ram as RAM,
										...
										if(mysqli_num_rows($cek) > 0){
			                                ...
			                                if ($kegunaan == 'Gaming') {
			                                    ...
			                                    while ($han = mysqli_fetch_assoc($cek)) {
			                                    	echo "<tr>";
			                                    	echo "<td>" . $han['Nama'] . "</td>";
			                                    	echo "<td>" . $han['Brand'] . "</td>";
			                                    	echo "<td>Rp." . $han['Harga'] . "</td>";
			                                    	echo "<td>" . $han['BobotRAM'] . "</td>";
			                                    	echo "<td>" . $han['BobotInternal'] . "</td>";
			                                    	echo "<td>" . $han['BobotProcessor'] . "</td>";
			                                    	echo "<td>" . $han['BobotKamera'] . "</td>";
			                                    	echo "<td>" . $han['BobotLayar'] . "</td>";
			                                    	echo "<td>" . $han['BobotBaterai'] . "</td>";
			                                    	echo"</tr>";
			                                	}
				...
				<table class="table table-striped jambo_table bulk_action">
					<thead class="thead-dark">
						<p><b>Normalisasi</b></p>
						<tr>
                         	<th scope="col">Normalisasi RAM</th>
                         	<th scope="col">Normalisasi Processor</th>
                         	<th scope="col">Normalisasi Internal</th>
                         	<th scope="col">Normalisasi Kamera Utama</th>
                         	<th scope="col">Normalisasi Layar</th>
                         	<th scope="col">Normalisasi Baterai</th>
                         	<th scope="col">Total Normalisasi</th>
                        </tr>
					</thead>
					<tbody>
					<?php 
						...
						if(isset($_POST['rangemin'])){
							...
							if (isset($brand)) {
								if ($brand =='Ya') {
                                	...
                                	echo "<tr>";
                                	echo "<td>" . $pramgaming . "</td>";
                                	echo "<td>" . $pprosesorgaming . "</td>";
                                	echo "<td>" . $pinternalgaming . "</td>";
                                	echo "<td>" . $playargaming . "</td>";
                                	echo "<td>" . $pkameragaming . "</td>";
                                	echo "<td>" . $pbateraigaming . "</td>";
                                	echo "<td>" . $tng . "</td>";
                                	echo"</tr>";
                                    ...
                                    echo "<tr>";
                                	echo "<td>" . $pramsosmed . "</td>";
                                	echo "<td>" . $pprosesorsosmed . "</td>";
                                	echo "<td>" . $pinternalsosmed . "</td>";
                                	echo "<td>" . $playarsosmed . "</td>";
                                	echo "<td>" . $pkamerasosmed . "</td>";
                                	echo "<td>" . $pbateraisosmed . "</td>";
                                	echo "<td>" . $tnsos . "</td>";
                                	echo"</tr>";
                                    ...
                                    echo "<tr>";
                                	echo "<td>" . $pramstreaming . "</td>";
                                	echo "<td>" . $pprosesorstreaming . "</td>";
                                	echo "<td>" . $pinternalstreaming . "</td>";
                                	echo "<td>" . $playarstreaming . "</td>";
                                	echo "<td>" . $pkamerastreaming . "</td>";
                                	echo "<td>" . $pbateraistreaming . "</td>";
                                	echo "<td>" . $tnstream . "</td>";
                                	echo"</tr>";
							...
							if(mysqli_num_rows($cek) > 0){
                                ...
                                if ($kegunaan == 'Gaming') {
                                    ...
                                    while ($hand = mysqli_fetch_array($cek)) {	
										...
										echo "<p><b>Vector S ".$hand['Nama']."</b></p>";
										echo "<ul>";
    										echo "<li>"."Vector S RAM = ".$pangkat_ram."</li>";
    										echo "<li>"."Vector S Processor = ".$pangkat_pro."</li>";
    										echo "<li>"."Vector S Internal = ".$pangkat_in."</li>";
    										echo "<li>"."Vector S Layar = ".$pangkat_la."</li>";
    										echo "<li>"."Vector S Kamera = ".$pangkat_kam."</li>";
    										echo "<li>"."Vector S Baterai = ".$pangkat_bat."</li>";
    										echo "<li>"."Vector S  = ".$V_S."</li>";
										echo "</ul>";
										$total_V_S += $V_S ;
                                	}


                                	echo "Total Vector S = ".$total_V_S;
                                	echo("<br>");
                                	...
                                	foreach ($kosong as $key => $value) {
                                    	...
                                    	echo "<td>" . $value['Processor'] . "</td>";
                                    	echo "<td>" . $value['Kamera'] . "</td>";
                                    	echo "<td>" . $value['Layar'] . "</td>";
                                    	echo "<td>" . $value['Baterai'] . "</td>";
                                    	echo"</tr>";
                                	}
